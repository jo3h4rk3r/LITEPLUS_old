...
public class MainMenu extends AbstractWindowScreen {
    ...
    public void init() {
        ...
        windows.add(new Window(width / 8,
                ...
                height / 8 + (height - height / 4), "LITEPlus v1.0", new ItemStack(Items.FEATHER)));
        windows.add(new Window(width / 8 + 15,
                height / 8 + 15,
                width / 8 + 15 + (width - width / 2),
                height / 8 + 15 + (height - height / 2), "LOGIN", new ItemStack(Items.PAPER), true));
        ...
        windows.get(0).buttons.add(
                new WindowButton(w / 2 - 100, h / 4 + 86, w / 2 - 2, h / 4 + 106, "DEV OPTIONS", () -> {
                    customTitleScreen = !customTitleScreen;
                    //FileHelper.saveMiscSetting("customTitleScreen", "false");
        ...
        if (checkBox == null)
            checkBox = new Checkbox(x + w / 2 - 99, y + h / 4 + 53, new LiteralText("Save Login"), false);
        checkBox.x = x + w / 2 - 99;
        checkBox.y = y + h / 4 + 53;
    ...
    public void render(MatrixStack matrix, int mouseX, int mouseY, float delta) {
        ...
        fill(matrix, 0, 0, width, height, 000000);
...
/*
    ...
    public void onRenderWindow(MatrixStack matrix, int window, int mX, int mY) {
        ...
        if (window == 0) {
            ...
            //drawStringWithShadow(matrix, this.textRenderer, "MINECRAFT", (x + w/3 - 81)/5, (y + h/4 - 15)/3,
           //  0xffc0e0);
